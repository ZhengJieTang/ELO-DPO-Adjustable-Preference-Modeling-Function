...
def get_alpacaeval(split: str) -> Dataset:
    ...
    dataset = datasets.load_dataset('tatsu-lab/alpaca_eval', split=split,cache_dir='/home/tzj/AiTest/HALOs-main/HALOs-main/cache/datasets/AI-ModelScope/alpaca_eval')
    if on_rank0():
...
def get_ultrabin(split: str) -> Dataset:
    ...
    dataset = datasets.load_dataset('HuggingFaceH4/ultrafeedback_binarized', split=split,cache_dir="/home/tzj/AiTest/dataset")
    #dataset = datasets.load_from_disk("/home/tzj/AiTest/dataset/ultrafeedback_binarized")
    if on_rank0():
